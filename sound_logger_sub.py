...
class SoundLogger:
    def __init__(self, dev_card = 1, sampling_rate = 44100, duration = 60, verbose=VERBOSE):
        ...
        p = 'sub_{:04d}-{:02d}{:02d}-{:02d}{:02d}{:02d}.wav'.format(utcnow.year, utcnow.month, utcnow.day, utcnow.hour,utcnow.minute, utcnow.second)
        self.lockpath = '/home/gb/.gb_lock/'+'sound_sub.lock'
        if self.__VERBOSE:
